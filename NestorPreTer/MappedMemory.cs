...
namespace Konamiman.NestorMSX.Memories
{
    ...
    public class MappedRam : IMemory
    {
        ...
        public void WriteToSegmentSelectionRegister(int page, byte segmentNumber)
        {
            segmentNumber &= segmentMask;
            if (segmentsInEachPage[page] == segmentNumber)
                return;

            addressOffsetsPerEachPage[(ushort)(page << 14)] = segmentNumber * segmentSize;
